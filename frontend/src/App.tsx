...
function App() {
  return (
    <Router>
      <div className="min-h-screen bg-[#020420]">
        {/* Navbar */}
        <nav className="fixed top-0 left-0 right-0 z-50 bg-[#020420]/80 backdrop-blur-lg border-b border-white/10">
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center">
                <a href="/" className="text-2xl font-bold">
                  ...
                  <span className="text-xs ml-1 text-white/60">v1.0</span>
                </a>
              </div>
